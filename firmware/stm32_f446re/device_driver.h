...
extern void Motor_Step(int direction);
extern void Motor_Stop(void);


// buzzer.c
extern void Buzzer_Play_Melody(void);
...
extern void OLED_Print(unsigned char page,
                       unsigned char column,
                       const char *str);

extern void OLED_Write_Char(unsigned char page,
                            unsigned char column,
                            char ch);
// oled_font.c
