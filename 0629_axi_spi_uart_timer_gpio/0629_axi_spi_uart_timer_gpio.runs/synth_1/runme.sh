...
HD_PWD='D:/jh_workspace/0629_axi_spi_uart_timer_gpio/0629_axi_spi_uart_timer_gpio.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_system_wrapper.tcl
