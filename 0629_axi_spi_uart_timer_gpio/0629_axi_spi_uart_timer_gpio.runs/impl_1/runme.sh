...
HD_PWD='D:/jh_workspace/0629_axi_spi_uart_timer_gpio/0629_axi_spi_uart_timer_gpio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axi_system_wrapper.tcl -notrace
